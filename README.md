...
lmp_to_xyz.py is extremely similar to the above two scripts. This takes a single frame of a LAMMPS trajectory, or a LAMMPS input structure file (.lmp) and converts it to XYZ format. The timestep is included in the comment line
