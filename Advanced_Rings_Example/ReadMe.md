This will cover an example of applied persistent homology analysis. This will follow closely to an already available [Homcloud example](https://homcloud.dev/py-tutorial/ml_pc_3d_visualization_by_plotly_en.html)
